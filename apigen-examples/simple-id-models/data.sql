...
insert into pets(name, owner_id, parent_id, tag_id) values ('Dog', '1', null, 1);
insert into pets(name, owner_id, parent_id, tag_id) values ('Cat', '1', 1, 1);
insert into pets(name, owner_id, parent_id, tag_id) values ('Potato', '1', 2, 2);
