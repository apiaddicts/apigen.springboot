...
class AbstractCrudLegacyServiceTest {
	...
	@Test
	void givenNonPersistedEntityWithId_whenCreated_thenError() {
		Entity entity = new Entity(1L);
		when(repository.findById(entity.getId())).thenReturn(Optional.of(entity));
		assertThrows(EntityIdAlreadyInUseException.class, () -> service.create(entity));
	}
	...
	private abstract class RelationsManager extends AbstractRelationsLegacyManager<Entity> {
	...
	private static class CrudService extends AbstractCrudLegacyService<Entity, Long, EntityRepository> {
		public CrudService(EntityRepository repository, AbstractRelationsLegacyManager<Entity> relationsManager, ApigenMapper<Entity> mapper) {
