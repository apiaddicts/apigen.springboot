...
public class EntityListResponseBuilder extends ListResponseBuilder {
    ...
    public EntityListResponseBuilder(String entityName, String listName, String basePackage) {
        super(listName, EntityOutputResourceBuilder.getTypeName(entityName, basePackage), basePackage);
