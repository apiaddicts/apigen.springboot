...
import net.cloudappi.apigen.generatorcore.generator.web.resource.input.InputResourceBuilderFactory;
import net.cloudappi.apigen.generatorcore.generator.web.resource.output.OutputResourceBuilder;
import net.cloudappi.apigen.generatorcore.generator.web.resource.output.OutputResourceBuilderFactory;
...
public class ResourcesGenerator extends AbstractGenerator {
    ...
    public ResourcesGenerator(Collection<Controller> controllers, String basePackage) {
        ...
        resourcesData = new ResourcesData(inputBuilders);
    }
