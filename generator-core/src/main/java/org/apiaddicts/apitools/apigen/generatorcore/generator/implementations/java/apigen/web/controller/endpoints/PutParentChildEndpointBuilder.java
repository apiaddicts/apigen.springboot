...
public class PutParentChildEndpointBuilder<C extends ApigenContext> extends PutEndpointBuilder<C> {

    public PutParentChildEndpointBuilder(Mapping rootMapping, Endpoint endpoint, C ctx, Configuration cfg) {
    ...
    protected void addStatements() {
        ...
        builder.addStatement("$L.update($L, updateRequest, updatedFields)", SERVICE_NAME, pathParams.get(1));
        builder.addStatement("$T createResult = $L.search($L, null, null, null)", entityType, SERVICE_NAME, pathParams.get(1));
