...
public class AbstractEntityRelationManager {
    ...
    protected Map<String, Map<String, Attribute>> manyToManyMappedEntities = new HashMap<>();

    protected Map<String, Map<String, Attribute>> manyToOneMappedEntities = new HashMap<>();

    /* <ForeignEntityName, <EntityName, Attribute>> */
    protected Map<String, Map<String, Attribute>> oneToManyMappedEntities = new HashMap<>();

    /* <ForeignEntityName, <EntityName, Attribute>> */
    protected Map<String, Map<String, Attribute>> oneToOneMappedEntities = new HashMap<>();
    ...
    protected Attribute getRelatedEntityAttributeOneToMany(String entityName, String relatedEntityName) {
        if (!manyToOneMappedEntities.containsKey(entityName)) return null;
        return manyToOneMappedEntities.get(entityName).get(relatedEntityName);
    }

    protected Attribute getRelatedEntityAttributeOneToOne(String entityName, String relatedEntityName) {
        return oneToOneMappedEntities.get(entityName).get(relatedEntityName);
    }

    protected Attribute getRelatedEntityAttributeManyToMany(String entityName, String relatedEntityName) {
        return manyToManyMappedEntities.get(entityName).get(relatedEntityName);
    }
}
