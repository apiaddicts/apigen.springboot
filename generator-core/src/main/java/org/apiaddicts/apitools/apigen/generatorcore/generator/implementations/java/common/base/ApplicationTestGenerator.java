...
public class ApplicationTestGenerator<C extends JavaContext> extends AbstractJavaGenerator<C> {

    protected FileBuilder builder;

    public ApplicationTestGenerator(C ctx, Configuration cfg) {
        super(ctx, cfg);
    }
    ...
    @Override
    public void init() {
        builder = new ApplicationTestBuilder<>(ctx, cfg);
    }
