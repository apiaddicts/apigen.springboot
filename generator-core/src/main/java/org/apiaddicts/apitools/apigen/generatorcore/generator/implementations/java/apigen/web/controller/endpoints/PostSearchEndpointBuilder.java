...
public class PostSearchEndpointBuilder<C extends ApigenContext> extends ApigenAbstractEndpointBuilder<C> {

    public PostSearchEndpointBuilder(Mapping rootMapping, Endpoint endpoint, C ctx, Configuration cfg) {
