...
import net.cloudappi.apigen.generatorcore.config.entity.Attribute;
...
class ServiceBuilderTests {
    ...
    void givenAnEntityWithStringAsPrimaryKey_whenGenerateService_thenConstructorMethodIsCorrect() {
        assertEquals("public Constructor(the.base.package.simpletestentity.SimpleTestEntityRepository repository,\n" +
                        "    @org.springframework.lang.Nullable net.cloudappi.apigen.archetypecore.core.AbstractRelationsManager<the.base.package.simpletestentity.SimpleTestEntity> relationsManager,\n" +
                        "    @org.springframework.lang.Nullable net.cloudappi.apigen.archetypecore.core.ApigenMapper<the.base.package.simpletestentity.SimpleTestEntity> mapper) {\n" +
