...
class EntityListResponseBuilderTests {
    ...
    @BeforeAll
    static void init() {
        EntityListResponseBuilder builder = new EntityListResponseBuilder("EntityName", "listName", "the.base.package");
    ...
    void givenListResponseBuilder_whenBuild_thenHaveSuperClassAndIsCorrect() {
        assertEquals("net.cloudappi.apigen.archetypecore.core.responses.ApiResponse<net.cloudappi.apigen.archetypecore.core.responses.content.ApiListResponseContent<the.base.package.entityname.web.EntityNameOutResource>>", typeSpec.superclass.toString());
    }
    ...
    void givenListResponseBuilder_whenBuild_thenHaveTypeSpec() {
        ...
        assertEquals("net.cloudappi.apigen.archetypecore.core.responses.content.ApiListResponseContent<the.base.package.entityname.web.EntityNameOutResource>", subTypeSpec.superclass.toString());
        ...
        assertEquals("getListName", methodSpec.name);
        assertEquals("[@com.fasterxml.jackson.annotation.JsonProperty(\"listName\")]", methodSpec.annotations.toString());
