...
class PostSearchEndpointBuilderTests {
    ...
    static void init() {
        ...
        PostSearchEndpointBuilder builderEndpoint = new PostSearchEndpointBuilder(new Mapping("/entities"), endPoint, "the.base.package");
    ...
    void givenPostSearchEndpointBuilder_whenBuild_thenHaveMethodSpecIsCorrect() {
        ...
        assertEquals("net.cloudappi.apigen.archetypecore.core.resource.FilterResource", parameterSpec.type.toString());
        assertEquals("body", parameterSpec.name);

        assertEquals("net.cloudappi.apigen.archetypecore.core.persistence.filter.Filter filter = body.getFilter();\n" +
                ...
                "net.cloudappi.apigen.archetypecore.core.persistence.ApigenSearchResult<the.base.package.entityname.EntityName> searchResult = service.search(select, exclude, expand, filter, orderby, init, limit, total);\n" +
