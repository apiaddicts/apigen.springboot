...
public class EntityObjectMother {
    ...
    public static Entity createSimpleEntityWithComposedID() {
    	List<Attribute> attributeList = new ArrayList<>();
    	List<Attribute> composedAttributes = new ArrayList<>();

        Attribute composedIdAttribute = new Attribute("id", "ComposedID");
        Attribute composedIdSAttribute = new Attribute("idS", "String");
        composedIdSAttribute.setColumns(Arrays.asList(new Column("id_s")));
        Attribute composedIdNAttribute = new Attribute("idN", "Long");
        composedIdNAttribute.setColumns(Arrays.asList(new Column("id_n")));
        composedAttributes.addAll(Arrays.asList(composedIdSAttribute,composedIdNAttribute));
        composedIdAttribute.setAttributes(composedAttributes);
    
        attributeList.add(composedIdAttribute);

        return new Entity("TestEntity", "tableName", attributeList);
    }
    ...
    public static Entity createEntityWithSequenceIdAttribute() {
        List<Attribute> attributeList = new ArrayList<>();
    ...
    public static Entity withManyToOne(String entityName, String fieldName, String relatedEntity, String columnName) {

        List<Attribute> attributes = new LinkedList<>();

        Attribute attribute = new Attribute(fieldName, relatedEntity);
        attribute.setIsCollection(false);

        Column column = new Column();
        column.setName(columnName);
        attribute.setColumns(Arrays.asList(column));

        Relation relationOwner = new Relation(relatedEntity);
        attribute.setRelation(relationOwner);

        attributes.add(attribute);

        return new Entity(entityName, entityName, attributes);
    }

	public static Entity createEntityWithAutogeneratedLongId() {
		List<Attribute> attributeList = new ArrayList<>();
	...
	public static Entity createEntityWithAutogeneratedStringId() {
		List<Attribute> attributeList = new ArrayList<>();
        ...
        Attribute longAttribute = new Attribute("id", "String");
        longAttribute.setColumns(Arrays.asList(column));
	...
	public static Entity createEntityWithoutAutogeneratedId() {
		List<Attribute> attributeList = new ArrayList<>();
