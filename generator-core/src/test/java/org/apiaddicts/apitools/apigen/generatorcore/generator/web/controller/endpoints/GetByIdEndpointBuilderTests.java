...
class GetByIdEndpointBuilderTests {
    ...
    static void init() {
        ...
        GetByIdEndpointBuilder builderEndpoint = new GetByIdEndpointBuilder(new Mapping("/entities"), endPoint, null, "the.base.package");
    ...
    void givenGetByIdEndpointBuilder_whenBuild_thenHaveMethodSpecIsCorrect() {
        ...
        assertEquals("namingTranslator.translate(select, exclude, expand, the.base.package.entityname.web.EntityNameOutResource.class);\n" +
