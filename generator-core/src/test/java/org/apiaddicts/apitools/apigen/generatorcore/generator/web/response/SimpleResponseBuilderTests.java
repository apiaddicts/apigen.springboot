...
class SimpleResponseBuilderTests {
    ...
    void givenSimpleResponseBuilder_whenBuild_thenHaveSuperClassAndIsCorrect() {
        assertEquals("org.apiaddicts.apitools.apigen.archetypecore.core.responses.ApiResponse<the.base.package.entityname.web.EntityNameOutResource>", typeSpec.superclass.toString());
    }
