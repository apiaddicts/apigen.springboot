...
class ResourceListResponseBuilderTests {
    ...
    void givenResourceListResponseBuilder_whenBuild_thenHaveSuperClassAndIsCorrect() {
        assertEquals("org.apiaddicts.apitools.apigen.archetypecore.core.responses.ApiResponse<org.apiaddicts.apitools.apigen.archetypecore.core.responses.content.ApiListResponseContent<the.base.package.resource.web.CreateResourceEndpointOutResource>>", typeSpec.superclass.toString());
    }
    ...
    void givenResourceListResponseBuilder_whenBuild_thenHaveTypeSpec() {
        ...
        assertEquals("org.apiaddicts.apitools.apigen.archetypecore.core.responses.content.ApiListResponseContent<the.base.package.resource.web.CreateResourceEndpointOutResource>", subTypeSpec.superclass.toString());
