package net.cloudappi.apigen.archetypecore.core.advice.controller;
...
public class FakeApiResponseErrorsController {
    ...
    public @ResponseBody
    ApiResponse postNotNullExpection(@Valid @RequestBody NotNullBody body) {
    ...
    @GetMapping(value = "/media-type", produces = MediaType.TEXT_XML_VALUE)
    public @ResponseBody ApiResponse getMediaTypeException() {
        throw new RuntimeException();
    }
