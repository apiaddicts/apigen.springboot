...
import net.cloudappi.apigen.archetypecore.core.persistence.ApigenSearch;
...
public abstract class AbstractReadService<E extends ApigenAbstractPersistable<K>, K extends Serializable, R extends ApigenRepository<E, K>> {
	...
	@Transactional(readOnly = true)
	public ApigenSearchResult<E> search(List<String> select, List<String> exclude, List<String> expand, Filter filter, List<String> orderBy, Integer init, Integer limit, Boolean total) {
